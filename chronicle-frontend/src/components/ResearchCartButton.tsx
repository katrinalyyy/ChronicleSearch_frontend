...
const ResearchCartButton: FC<Props> = ({ count = 0, onClick, disabled = false }) => {
  return (
    <button className="research-button" onClick={onClick} disabled={disabled}>
      <svg 
      ...
      <div className="research-count">{count}</div>
    </button>
  )
}

export default ResearchCartButton
